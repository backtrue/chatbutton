# ToldYou Button Terms of Service
...
- You must obtain all necessary rights and consents to share End Users' personal data with us or messaging platforms.
- We may rate-limit, throttle, or suspend access to prevent misuse, protect system integrity, or comply with legal obligations.

## 7. Customer Content
You retain ownership of Customer Content. By submitting Customer Content, you grant ToldYou a non-exclusive, worldwide, royalty-free license to host, display, and distribute the content solely as needed to provide the Services. You represent and warrant that Customer Content:
- does not infringe any third-party rights;
- is accurate and lawful;
- does not contain malicious code or deceptive links; and
- complies with our Acceptable Use requirements in Section 8.

## 8. Acceptable Use
You agree not to:
1. use the Services for spam, scams, phishing, or other deceptive practices;
2. misrepresent the origin of messages or impersonate another person or brand without permission;
3. probe, scan, or test the vulnerability of any ToldYou system without written authorization;
...
The Services may integrate with or link to third-party platforms (e.g., LINE, Facebook Messenger, Instagram, WhatsApp). ToldYou does not control these platforms and is not responsible for their terms, privacy practices, or functionality. You are solely responsible for complying with third-party terms and acquiring necessary permissions.

## 10. Intellectual Property
The Services, including all software, trademarks, logos, and content provided by ToldYou, are owned by or licensed to ToldYou and protected by applicable intellectual property laws. Except for the limited rights expressly granted in these Terms, no other rights are conveyed. You may not use our branding without written permission.

## 11. Feedback
If you provide feedback or suggestions, you grant us a perpetual, irrevocable, worldwide license to use that feedback without restriction or compensation.

## 12. Confidentiality
"Confidential Information" means non-public information disclosed by one party to the other that is designated as confidential or reasonably should be understood to be confidential. Each party will protect the other's Confidential Information using reasonable care and not disclose it to third parties, except as required to provide the Services or comply with law.

## 13. Data Protection
Use of the Services is subject to our [Privacy Policy](./privacy-policy.md) which explains how we process personal data. Customers must provide required notices and obtain consents from End Users whose data is processed through the Services.
...
These Terms are governed by the laws of Taiwan (Republic of China), without regard to conflict of law principles. The Taipei District Court shall have exclusive jurisdiction over any disputes arising from or relating to these Terms, except that either party may seek injunctive or equitable relief in any jurisdiction to protect intellectual property or Confidential Information.

## 19. Force Majeure
We are not liable for delays or failures to perform due to events beyond our reasonable control, including natural disasters, power failures, telecommunications outages, governmental actions, pandemics, or labor disputes.
...
## 21. Entire Agreement
These Terms, together with any order forms and policies referenced herein, constitute the entire agreement between you and ToldYou regarding the Services and supersede all prior agreements.
